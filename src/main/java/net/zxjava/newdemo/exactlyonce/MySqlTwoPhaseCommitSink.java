...
public class MySqlTwoPhaseCommitSink extends TwoPhaseCommitSinkFunction<ObjectNode, Connection, Void> {
	...
	private static final long serialVersionUID = 3157646455820492855L;
	...
	protected Connection beginTransaction() throws Exception {
		...
		String url = "jdbc:mysql://172.29.20.117:3306/test?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false&autoReconnect=true";
