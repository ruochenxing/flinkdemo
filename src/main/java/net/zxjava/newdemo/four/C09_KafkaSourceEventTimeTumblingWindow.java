...
public class C09_KafkaSourceEventTimeTumblingWindow {
	public static void main(String[] args) throws Exception {
		...
		// kafkaSource
		FlinkKafkaConsumer011<String> kafkaSource = new FlinkKafkaConsumer011<>("wc10", new SimpleStringSchema(), // 序列化与反序列化方式
				props);
		...
		SingleOutputStreamOperator<String> lines = kafkaLines// env.socketTextStream("localhost", 7777)
				.assignTimestampsAndWatermarks(new BoundedOutOfOrdernessTimestampExtractor<String>(Time.seconds(0)) {
					private static final long serialVersionUID = 7717960662086335531L;
		...
		SingleOutputStreamOperator<Tuple2<String, Integer>> wordAndCount = lines
				.map(new MapFunction<String, Tuple2<String, Integer>>() {
					...
					private static final long serialVersionUID = 1965819720374815812L;
