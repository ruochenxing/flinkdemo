...
public class C02_WordCountSQL {
	public static void main(String[] args) throws Exception {
		...
		// 模拟测试数据
		DataSource<C01_WordCount> input = env.fromElements(new C01_WordCount("Storm", 1L),
				new C01_WordCount("Spark", 1L), new C01_WordCount("Flink", 1L), new C01_WordCount("Spark", 1L),
				new C01_WordCount("Flink", 1L), new C01_WordCount("Flink", 1L));
