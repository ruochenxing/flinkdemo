...
public class C06_SharingGroupTest {
	public static void main(String[] args) throws Exception {
		...
		SingleOutputStreamOperator<String> word = lines.flatMap(new FlatMapFunction<String, String>() {
			private static final long serialVersionUID = -8577949704051358041L;
		...
		SingleOutputStreamOperator<String> filtered = word.filter(new FilterFunction<String>() {
			private static final long serialVersionUID = 4730826431959882345L;
		...
		SingleOutputStreamOperator<Tuple2<String, Integer>> wordAndOne = filtered
				.map(new MapFunction<String, Tuple2<String, Integer>>() {
					private static final long serialVersionUID = -221574423169034574L;
