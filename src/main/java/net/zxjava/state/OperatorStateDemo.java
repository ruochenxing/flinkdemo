 ...
 *
 * 输出如下： (5,2 3 4 7 5) (3,5 4 6) (3,7 8 9)
 */
public class OperatorStateDemo {
	...
	public static class OperatorStateMap extends RichFlatMapFunction<Long, Tuple2<Integer, String>>
		...
		private static final long serialVersionUID = 4595753323155552512L;
		// 托管状态
		...
		public void initializeState(FunctionInitializationContext context) throws Exception {
			ListStateDescriptor<Long> listStateDescriptor = new ListStateDescriptor<Long>("checkPointedList",
